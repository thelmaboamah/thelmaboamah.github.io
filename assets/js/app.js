$(document).ready(function() {
  ...
  var projects = [
    ...
    },
    {
      ...
      description:
        "A an embeddable web widget versions of the <a href='https://play.google.com/store/apps/details?id=org.getamplify.amplify' target='_blank' rel='noreferrer'>Amplify mobile app</a>. Winner of <a href='http://angelhack.com/' target='_blank' rel='noreferrer'>Angelhack Hackathon</a> in April 2017.",
    ...
    //   name: 'JS Drumkit',
    //   description:
    //     "An interactive drumkit built with Vanilla JS as part of <a href='http://javascript30.com'>JavaScipt30</a>.",
  ...
  var thumbnails = '';
  for (var i = 0; i < 3; i++) {
    thumbnails += `<a class="thumbnail" href="work.html"><img src="${projects[i].image}" alt="${projects[i]
      .alt}"/></a>`;
  }
  ...
  for (var i = 0; i < projects.length; i++) {
    samples += `<div class="sample col-xs-12 col-md-6 col-lg-4">
									<a href="${projects[i].url}" target="_blank" rel="noreferrer"><img class="img-fluid" src="${projects[i]
      .image}" alt="${projects[i].alt}"/></a>
									<div>
